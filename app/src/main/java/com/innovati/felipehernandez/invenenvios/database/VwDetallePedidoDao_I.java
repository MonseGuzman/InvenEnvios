...
*/
public class VwDetallePedidoDao_I extends AbstractDao<VwDetallePedido_I, Long> {
    ...
    public VwDetallePedidoDao_I(DaoConfig config) {
        super(config);
    }
    
    public VwDetallePedidoDao_I(DaoConfig config, DaoSession daoSession) {
