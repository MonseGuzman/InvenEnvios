...
/** 
 * DAO for table "USUARIOS__I".
*/
public class Usuarios_IDao extends AbstractDao<Usuarios_I, Long> {

    public static final String TABLENAME = "USUARIOS__I";
    ...
    public Usuarios_IDao(DaoConfig config) {
        super(config);
    }
    
    public Usuarios_IDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"USUARIOS__I\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"USUARIOS__I\"";
        db.execSQL(sql);
    }
