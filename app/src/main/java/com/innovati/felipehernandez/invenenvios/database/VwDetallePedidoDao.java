...
/** 
 * DAO for table "VW_DETALLE_PEDIDO".
*/
public class VwDetallePedidoDao extends AbstractDao<VwDetallePedido, Long> {

    public static final String TABLENAME = "VW_DETALLE_PEDIDO";

    /**
     * Properties of entity VwDetallePedido.<br/>
    ...
    public VwDetallePedidoDao(DaoConfig config) {
        super(config);
    }
    
    public VwDetallePedidoDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"VW_DETALLE_PEDIDO\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"VW_DETALLE_PEDIDO\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, VwDetallePedido entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, VwDetallePedido entity) {
        stmt.clearBindings();
    ...
    @Override
    public VwDetallePedido readEntity(Cursor cursor, int offset) {
        VwDetallePedido entity = new VwDetallePedido( //
    ...
    @Override
    public void readEntity(Cursor cursor, VwDetallePedido entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(VwDetallePedido entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(VwDetallePedido entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(VwDetallePedido entity) {
