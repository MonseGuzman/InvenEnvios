...
/** 
 * DAO for table "PEDIDOS__I".
*/
public class Pedidos_IDao extends AbstractDao<Pedidos_I, Long> {

    public static final String TABLENAME = "PEDIDOS__I";
    ...
    public Pedidos_IDao(DaoConfig config) {
        super(config);
    }
    
    public Pedidos_IDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PEDIDOS__I\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PEDIDOS__I\"";
        db.execSQL(sql);
    }
