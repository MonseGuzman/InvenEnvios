...
*/
public class VwUsuariosDao_I extends AbstractDao<VwUsuarios_I, Long> {
    ...
    public VwUsuariosDao_I(DaoConfig config) {
        super(config);
    }
    
    public VwUsuariosDao_I(DaoConfig config, DaoSession daoSession) {
