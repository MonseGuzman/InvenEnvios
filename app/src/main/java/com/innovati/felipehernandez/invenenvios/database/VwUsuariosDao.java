...
/** 
 * DAO for table "VW_USUARIOS".
*/
public class VwUsuariosDao extends AbstractDao<VwUsuarios, Long> {

    public static final String TABLENAME = "VW_USUARIOS";

    /**
     * Properties of entity VwUsuarios.<br/>
    ...
    public VwUsuariosDao(DaoConfig config) {
        super(config);
    }
    
    public VwUsuariosDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"VW_USUARIOS\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"VW_USUARIOS\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, VwUsuarios entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, VwUsuarios entity) {
        stmt.clearBindings();
    ...
    @Override
    public VwUsuarios readEntity(Cursor cursor, int offset) {
        VwUsuarios entity = new VwUsuarios( //
    ...
    @Override
    public void readEntity(Cursor cursor, VwUsuarios entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(VwUsuarios entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(VwUsuarios entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(VwUsuarios entity) {
